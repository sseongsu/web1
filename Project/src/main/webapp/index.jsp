...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="index.jsp" class="logo">coman</a>
					<nav id="nav">
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1> 초보 사장님들을 위한<span><br />
					“Cost management”</span></h1>
					<ul class="actions">
						<!-- <li><a href="#" class="button alt">소개 글로</a></li> -->
					</ul>
				</div>
			</section>
		...
		<section id="one">
				<div class="inner">
					<header>
						<h2>왜 이런 계산을 해야 할까요?</h2>
					</header>
					<ul class="actions">
						<li><a href="./info.spring" class="button alt">소개 글로 가기</a></li>
					</ul>
				</div>
			</section>
